...
namespace Barotrauma.Networking
{
    sealed class GameServer : NetworkMember
    {
        ...
        private IEnumerable<CoroutineStatus> StartMonsters()
        {
            ...
            string[][] monsters = {
                hope, randos,
                crawler, mudraptor, mantis, hammerheadspawn, swarmfeeder, huskcontainer, husk, small,
            ...
            string[] monsternames = {
                ...
                "hammerhead spawn", "swarmfeeders", "huskcontainers", "husk", "small monsters", "aggressive monsters", "threshers", "baby monsters", "spinelings", "cells",
                "aliens", "defense bots"
                //"Survivator fish",
                //"SOMA monsters",
                //"Deadspace monsters",
